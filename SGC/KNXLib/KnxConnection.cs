...
namespace SGC.KNXLib
{
    public abstract class KnxConnection
    {
        ...
        public void Action(string address, byte[] data)
        {
            ...
            Console.WriteLine(ClassName + "Sending 0x{0} to {1}." + BitConverter.ToString(data) + " " + address);
            ...
            Console.WriteLine(ClassName + "Sent 0x{0} to {1}." + BitConverter.ToString(data) + " " + address);
        }
